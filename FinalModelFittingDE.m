...
dataconc = readtable('LS-P01-072-conc-ramps.csv');
datadiff = readtable('LS-P01-069-different-excess-all.csv');
...
ylabel('[1b]/[2]', 'FontSize',24)
zlabel('[pyrazole 4b] / M', 'FontSize',24)
shading('interp')
hold off

legend('','Residence time ramps','Reactant stoichiometry ramps', 'Location','southeast')
